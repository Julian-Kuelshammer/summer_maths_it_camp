...
@[simp] lemma add_x (v w : ℝ²) : (v + w).x = v.x + w.x := sorry
@[simp] lemma add_y (v w : ℝ²) : (v + w).y = v.y + w.y := sorry
...
@[simp] lemma zero_x : (0 : ℝ²).x = 0 := sorry
@[simp] lemma zero_y : (0 : ℝ²).y = 0 := sorry
...
@[simp] lemma neg_x (v : ℝ²) : (-v).x = -v.x := sorry
@[simp] lemma neg_y (v : ℝ²) : (-v).y = -v.y := sorry
...
@[simp] lemma smul_x (a : ℝ) (v : ℝ²) : (a • v).x = a * v.x := sorry
@[simp] lemma smul_y (a : ℝ) (v : ℝ²) : (a • v).y = a * v.y := sorry
